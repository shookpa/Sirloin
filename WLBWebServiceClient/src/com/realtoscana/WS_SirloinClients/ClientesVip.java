...
public class ClientesVip  implements java.io.Serializable {
	...
	public String toString() {
		return "ClientesVip [num_vip=" + num_vip + ", nom_vip=" + nom_vip + ", tel_vip=" + tel_vip + ", ema_vip="
				+ ema_vip + ", fec_vip=" + fec_vip + ", sal_vip=" + sal_vip + ", fuc_vip=" + fuc_vip + ", muc_vip="
				+ muc_vip + ", fup_vip=" + fup_vip + ", mup_vip=" + mup_vip + ", tnr_vip=" + tnr_vip + ", tmr_vip="
				+ tmr_vip + ", tct_vip=" + tct_vip + ", pto_vip=" + pto_vip + ", pva_vip=" + pva_vip + ", datetime_vip="
				+ datetime_vip + ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc=" + __hashCodeCalc + "]";
	}
